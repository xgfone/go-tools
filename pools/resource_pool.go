...
// Copy from github.com/youtube/vitess/go/pools:resource_pool.go
...
type ResourcePool struct {
	...
	factory     Factory
	capacity    atomics.AtomicInt64
	idleTimeout atomics.AtomicDuration

	// stats
	waitCount atomics.AtomicInt64
	waitTime  atomics.AtomicDuration
}
...
func NewResourcePool(factory Factory, capacity, maxCap int, idleTimeout time.Duration) *ResourcePool {
	...
	rp := &ResourcePool{
		...
		factory:     factory,
		capacity:    atomics.NewAtomicInt64(int64(capacity)),
		idleTimeout: atomics.NewAtomicDuration(idleTimeout),
	}
